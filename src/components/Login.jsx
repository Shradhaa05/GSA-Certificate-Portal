...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-100 via-white to-blue-50 px-4">
      ...
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-sky-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float" style={{ animationDelay: '2s' }} />

      <div className="w-full max-w-md z-10">
        {/* Logo / Header area */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center p-3.5 bg-blue-600 rounded-2xl shadow-lg shadow-blue-500/20 mb-4 animate-float">
        ...
        {/* Card Form */}
        <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-sky-100 shadow-xl p-8 transition-all duration-300 hover:shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Shradha Sangita Dash"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="shradhasangitadash@gmail.com"
                  className={`w-full pl-10 pr-4 py-2.5 rounded-xl border bg-white/50 text-slate-800 placeholder-slate-400 transition-all duration-200 focus:bg-white
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <button
                type="button"
                onClick={handleClear}
                className="w-full py-2.5 px-4 rounded-xl border border-slate-200 text-slate-600 font-semibold text-sm transition-all hover:bg-slate-50 active:scale-95"
              >
                Clear Form
              </button>
              <button
                type="submit"
                className="w-full py-2.5 px-4 rounded-xl bg-blue-600 text-white font-semibold text-sm shadow-md shadow-blue-500/10 transition-all hover:bg-blue-700 hover:shadow-lg active:scale-95"
              >
                Continue
              </button>
            </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          &copy; 2026 Google Student Ambassador Program. All rights reserved.
        </p>
      </div>
    </div>
  );
